...
/******************************************************************************
* FIXED:
* 1: the problem is that first thread tries to require locka then tries to 
*    require lockb before releasing the locka. At the same time, second thread
*    tries to acquire lockb then locka before releasing lockb which will cause
*    DEADLOCK! Put locks at correct position can fix the problem.
* 
******************************************************************************/
