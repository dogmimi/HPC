...
/******************************************************************************
* FIXED:
* 1: task 1's offset should start at 0. If it starts at REPS, it will access
*    index which is out of reqs.
* 2: task 2 do not have any nonblocking code, it uses MPI_Send to send data,
*    so it SHOULDN'T call MPI_Waitall which will cause problem. Simply uses if
*    check to make sure it won't call MPI_Waitall in this case.
******************************************************************************/
